    ...
    return `
        <div class="text-center">
            ...
            <div class="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-4">
                <button class="w-full sm:w-56 border-2 border-blue-500 text-blue-500 hover:bg-blue-600 font-urbanist font-bold py-2 px-6 rounded-full transition-colors duration-200">
                    Create Wallet
                </button>
